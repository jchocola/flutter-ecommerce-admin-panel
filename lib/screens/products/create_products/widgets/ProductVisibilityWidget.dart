...
class ProductOfferWidget extends StatefulWidget {
  const ProductOfferWidget({super.key});

  @override
  State<ProductOfferWidget> createState() => _ProductOfferWidgetState();
}

class _ProductOfferWidgetState extends State<ProductOfferWidget> {
