...
class CreateProductsTablet extends StatefulWidget {
  const CreateProductsTablet({super.key});

  @override
  State<CreateProductsTablet> createState() => _CreateProductsTabletState();
}

class _CreateProductsTabletState extends State<CreateProductsTablet> {
