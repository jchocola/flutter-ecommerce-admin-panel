...
class CreateProductsMobile extends StatefulWidget {
  const CreateProductsMobile({super.key});

  @override
  State<CreateProductsMobile> createState() => _CreateProductsMobileState();
}

class _CreateProductsMobileState extends State<CreateProductsMobile> {
