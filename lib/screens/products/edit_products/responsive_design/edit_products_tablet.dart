...
class EditProductsTablet extends StatefulWidget {
  const EditProductsTablet({super.key, required this.productModel});

  final ProductModel productModel;

  @override
  State<EditProductsTablet> createState() => _EditProductsTabletState();
}

class _EditProductsTabletState extends State<EditProductsTablet> {
