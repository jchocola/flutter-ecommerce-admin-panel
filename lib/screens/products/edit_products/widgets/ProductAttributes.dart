...
class ProductAttributesEdit extends StatelessWidget {
  ProductAttributesEdit({super.key, this.productAttributes});
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ Inject existing attributes if editing
    if (productAttributes != null &&
        productAttributes!.isNotEmpty &&
        attributeController.productAttributes.isEmpty) {
      attributeController.productAttributes.assignAll(productAttributes!);
    }
    return Column(
      ...
      children: [
              ...
              TDeviceUtils.isDesktopScreen(context)
                  ? Row(
                    ...
                    children: [
                      ...
                      Expanded(flex: 2, child: _buildAttributesTextField()),
                      const SizedBox(width: TSizes.spaceBetwwenItems),
                    ...
                    itemBuilder: (_, index) {
                      return Container(
                        ...
                        child: ListTile(
                          ...
                          trailing: IconButton(
                            onPressed:
                                () => attributeController.removeAttributes(
                                  index,
                                  context,
                                ),
        ...
        Obx(() {
          return productController.productType.value == ProductType.variable &&
              ...
              ? Center(
                child: SizedBox(
                  ...
                  child: GestureDetector(
                    onTap:
                        () => variationController.generateVariationConfirmation(
                          context,
                        ),
                    child: Container(
                      decoration: BoxDecoration(
...
ListView buildAttributesList(
  ...
  return ListView.separated(
    shrinkWrap: true,
    physics:
        const NeverScrollableScrollPhysics(), // Prevent scroll conflict if inside scrollable
    itemCount: controller.productAttributes.length, // ✅ dynamic count
    separatorBuilder:
        (_, __) => const SizedBox(height: TSizes.spaceBetwwenItems),
    itemBuilder: (_, index) {
      ...
      return Container(
        ...
        child: ListTile(
          title: Text(
            attribute.name?.trim().isNotEmpty == true
                ? attribute.name!
                : 'Unnamed Attribute',
          ),
          subtitle: Text(
    ...
    child: GestureDetector(
      ...
      child: TRoundedContainer(
        ...
        child: Padding(
          ...
          child: Text(
            'Add',
            style: TextStyle(color: dark ? Colors.white : Colors.white),
          ),
        ),
      ),
    ),
  ...
  return TextFormField(
    ...
    decoration: InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(
          color:
              dark ? Colors.white.withOpacity(1) : TColors.dark.withOpacity(1),
        ),
      ),
