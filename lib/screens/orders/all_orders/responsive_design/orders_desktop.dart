...
import 'package:admin_panel/screens/orders/all_orders/table/order_table.dart';
...
class OrdersDesktop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Get.put(OrderControllerSearch());
    return Scaffold(
               ...
               TRoundedContainer(
                ...
                borderColor: dark ? Colors.grey.withOpacity(0.5) : TColors.dark.withOpacity(0.2),
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        TTableHeader(buttonText: 'Create New Order', onPressed: () {
                          ;
                        }, searchController: controller.searchController,
                        searchOnChanged: (value) => controller.filterOrdersByQuery(value),),
                        SizedBox(height: TSizes.spaceBetwwenItems,),
                    
                        RepaintBoundary(child: const OrderTable()),
                      ],
                    ),
                  ),
                ),
