...
class EditOrdersTablet extends StatefulWidget {
  EditOrdersTablet({super.key, required this.orders});

  final Map<String, dynamic> orders;

  @override
  State<EditOrdersTablet> createState() => _EditOrdersTabletState();
}

class _EditOrdersTabletState extends State<EditOrdersTablet> {
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  const SizedBox(height: TSizes.spaceBetwwenItems),
                  FutureBuilder<CustomerModel?>(
                    future: controller.fetchUserByID(widget.orders['userID']),
                    builder: (context, snapshot) {
...
class _TOrderSummaryStatsState extends State<TOrderSummaryStats> {
  ...
  void initState() {
    super.initState();
    selectedStatus = orderStatusFromString(widget.orders['orderStatus']);
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            Column(children: [Text('Date'), Text('data')]),
                              ...
                              child: DropdownButtonFormField<String>(
                                ...
                                onChanged: (value) {
                                  if (value != null) {
                                    setState(() {
                                      print(value);
                                      selectedStatus = orderStatusFromString(
                                        value,
                                      );
                                      updateStatus(value);
