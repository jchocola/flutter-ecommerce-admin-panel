...
class EditOrdersMobile extends StatefulWidget {
  EditOrdersMobile({super.key, required this.orders});

  final Map<String, dynamic> orders;

  @override
  State<EditOrdersMobile> createState() => _EditOrdersMobileState();
}

class _EditOrdersMobileState extends State<EditOrdersMobile> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: TSizes.spaceBetwwenItems),
            Row(children: [Text('Date'), Text('data')]),
            const SizedBox(height: TSizes.spaceBetwwenItems),
            Container(
              width: 300,
              child: Flexible(
